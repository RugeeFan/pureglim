...
export function isTwilioMockMode() {
  // Strict allowlist: dev only. "Not production" was too loose — staging
  // and any unknown deployment env (NODE_ENV unset) would have leaked the
  // mock code. Now you have to deliberately set NODE_ENV=development.
