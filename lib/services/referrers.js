...
export function buildReferralDiscountSummary({ code, referrer, originalAmount }) {
  ...
  return {
    ...
    // Never return phone as the displayable name — that would leak PII.
    // Public callers should NOT include this in API responses; use it only
    // for server-side / admin contexts.
