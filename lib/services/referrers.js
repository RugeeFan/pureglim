...
export async function createReferrerAccount({ fullName, phone }) {
...
export async function findOrCreateVerifiedReferrer({ fullName, phone, mode }) {
  ...
  if (mode === "register") {
    ...
    return createReferrerAccount({ fullName, phone });
  }
